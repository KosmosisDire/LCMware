...
#ifndef __core_ActionStatus_hpp__
#define __core_ActionStatus_hpp__
...
int ActionStatus::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ActionStatus::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int ActionStatus::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t ActionStatus::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* ActionStatus::getTypeName()
{
    return "ActionStatus";
}

int ActionStatus::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ActionStatus::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int ActionStatus::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t ActionStatus::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == ActionStatus::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, ActionStatus::getHash };

    uint64_t hash = 0x8357197188faba20LL +
