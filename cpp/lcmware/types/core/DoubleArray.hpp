...
#ifndef __core_DoubleArray_hpp__
#define __core_DoubleArray_hpp__
...
int DoubleArray::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int DoubleArray::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int DoubleArray::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t DoubleArray::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* DoubleArray::getTypeName()
{
    return "DoubleArray";
}

int DoubleArray::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int DoubleArray::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int DoubleArray::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t DoubleArray::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == DoubleArray::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, DoubleArray::getHash };
