...
#ifndef __examples_ImageMessage_hpp__
#define __examples_ImageMessage_hpp__
...
int ImageMessage::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ImageMessage::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int ImageMessage::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t ImageMessage::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* ImageMessage::getTypeName()
{
    return "ImageMessage";
}

int ImageMessage::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ImageMessage::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int ImageMessage::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t ImageMessage::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == ImageMessage::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, ImageMessage::getHash };

    uint64_t hash = 0x5f79e8dbcd0c9cc1LL +
