...
public final class Command implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(core.Command.class))
            return 0L;
 
        classes.add(core.Command.class);
    ...
    public Command(DataInput ins) throws IOException
    {
    ...
    public static core.Command _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        core.Command o = new core.Command();
    ...
    public core.Command copy()
    {
        core.Command outobj = new core.Command();
