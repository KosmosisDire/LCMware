...
public final class KeyValueArray implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(core.KeyValueArray.class))
            return 0L;
 
        classes.add(core.KeyValueArray.class);
    ...
    public KeyValueArray(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public KeyValueArray(DataInput ins) throws IOException
    {
    ...
    public static core.KeyValueArray _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        core.KeyValueArray o = new core.KeyValueArray();
    ...
    public core.KeyValueArray copy()
    {
        core.KeyValueArray outobj = new core.KeyValueArray();
