...
public final class String implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(core.String.class))
            return 0L;
 
        classes.add(core.String.class);
    ...
    public static core.String _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        core.String o = new core.String();
    ...
    public core.String copy()
    {
        core.String outobj = new core.String();
