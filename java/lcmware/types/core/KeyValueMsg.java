 ...
 * Key-Value pair
 */
public final class KeyValueMsg implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(core.KeyValueMsg.class))
            return 0L;
 
        classes.add(core.KeyValueMsg.class);
    ...
    public KeyValueMsg(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public KeyValueMsg(DataInput ins) throws IOException
    {
    ...
    public static core.KeyValueMsg _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        core.KeyValueMsg o = new core.KeyValueMsg();
    ...
    public core.KeyValueMsg copy()
    {
        core.KeyValueMsg outobj = new core.KeyValueMsg();
