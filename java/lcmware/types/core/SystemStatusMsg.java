 ...
 * System status
 */
public final class SystemStatusMsg implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(core.SystemStatusMsg.class))
            return 0L;
 
        classes.add(core.SystemStatusMsg.class);
    ...
    public SystemStatusMsg(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public SystemStatusMsg(DataInput ins) throws IOException
    {
    ...
    public static core.SystemStatusMsg _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        core.SystemStatusMsg o = new core.SystemStatusMsg();
    ...
    public core.SystemStatusMsg copy()
    {
        core.SystemStatusMsg outobj = new core.SystemStatusMsg();
